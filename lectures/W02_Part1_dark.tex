...
\definecolor{PUGold}{RGB}{160,30,30}
...
\definecolor{PUOrange}{RGB}{160,30,30}
  ...
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
      ...
      \begin{block}{Part 2 Preview}
        Research Article: Halevy, Rajaraman \& Ordille (2006)\\
...
\begin{frame}{Data Quality: Six Dimensions (DAMA Framework)}
 \centering
      ...
      \begin{tabular}{p{2.0cm}p{4cm}p{7cm}}
        \toprule
...
\begin{frame}{Textbook \& Reading References}
  ...
  \end{block}
  \vspace{6pt}
  \begin{exampleblock}{Supplementary (Covered in Week 2, Part 2 — Research Articles)}
    \begin{itemize}
      \small
...
\begin{frame}[c]
  \begin{center}
    ...
    \begin{block}{\centering Next Lecture: Week 2, Part 2}
      \centering
      Research Article: Halevy, Rajaraman \& Ordille (2006) — \textit{``Data Integration: The Teenage Years''}\\[4pt]
