...
\begin{frame}{Textbook \& Reading References}
  ...
  \end{block}
  \vspace{4pt}
  \begin{exampleblock}{Research Articles (covered in Week 10, Part 2)}
    \begin{itemize}
      \small
...
\begin{frame}[c]
  \begin{center}
    ...
    \begin{block}{\centering Next Lecture: Week 10, Part 2}
      \centering
      Research Articles: Kwak et al.\ (2010) Twitter as news medium $\cdot$ Taylor \& Letham (2018) Prophet $\cdot$ Obermeyer \& Emanuel (2016) clinical ML\\[4pt]
