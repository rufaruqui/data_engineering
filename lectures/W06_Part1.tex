...
\begin{frame}{Textbook \& Reading References}
  ...
  \end{block}
  \vspace{6pt}
  \begin{exampleblock}{Supplementary (Covered in Week 6, Part 2 --- Research Articles)}
    \begin{itemize}
      \small
...
\begin{frame}[c]
  \begin{center}
    ...
    \begin{block}{\centering Next Lecture: Week 6, Part 2}
      \centering
      Research Article 1: Zaharia et al.\ (2010) --- \textit{``Spark: Cluster Computing with Working Sets''}\\[4pt]
      Research Article 2: Zaharia et al.\ (2012) --- \textit{``Resilient Distributed Datasets''}\\[4pt]
