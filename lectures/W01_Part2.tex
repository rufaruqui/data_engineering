...
% Week 1, Part 2: Research Article & Case Study
...
\subtitle{Week 1, Part 2 \textemdash\  Research Articles \& Case Study}
...
\begin{frame}{Part 2 Overview}
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
      \begin{exampleblock}{Research Articles Covered}
        \begin{enumerate}
...
\begin{frame}[c]
  \begin{center}
    ...
    \begin{block}{\centering Next Week: Week 2 (Part 1 \& Part 2)}
      ...
      \small Research Article: Halevy, Rajaraman \& Ordille (2006) $\cdot$ Case Study: Healthcare Interoperability (HL7/FHIR)
    \end{block}
    \vspace{8pt}
