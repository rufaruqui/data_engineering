...
\begin{frame}{Textbook \& Reading References}
  ...
  \end{block}
  \vspace{4pt}
  \begin{exampleblock}{Graduate Reference and Research Article (covered in Week 8, Part 2)}
    \begin{itemize}
      \small
...
\begin{frame}[c]
  \begin{center}
    ...
    \begin{block}{\centering Next Lecture: Week 8, Part 2}
      \centering
      Research Article: Kreps, Narkhede \& Rao (2011) --- \textit{``Kafka: A Distributed Messaging System for Log Aggregation''}\\[4pt]
