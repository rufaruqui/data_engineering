...
% Week 2, Part 2: Research Article & Case Study
...
\subtitle{Week 2, Part 2 \textemdash\ Research Article \& Case Study}
...
\begin{frame}{Part 2 Overview — Week 2}
  \begin{columns}[T]
    ...
    \column{0.50\textwidth}
      \begin{exampleblock}{Research Article Covered}
        \begin{enumerate}
  ...
  \begin{columns}[T]
    ...
    \column{0.47\textwidth}
      ...
      \begin{tikzpicture}[
        ...
        \node[box, fill=PUNavy!20]  (wa)  at (-2.2, 1.5) {Wrapper A\\{\tiny RDBMS}};
        \node[box, fill=PUNavy!20]  (wb)  at (0,    1.5) {Wrapper B\\{\tiny XML feed}};
        \node[box, fill=PUNavy!20]  (wc)  at (2.2,  1.5) {Wrapper C\\{\tiny REST API}};
        \node[box, fill=PUGreen!20] (sa)  at (-2.2, 0.3) {Source A};
        \node[box, fill=PUGreen!20] (sb)  at (0,    0.3) {Source B};
        \node[box, fill=PUGreen!20] (sc)  at (2.2,  0.3) {Source C};
