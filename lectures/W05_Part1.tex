...
\begin{frame}{Textbook \& Reading References}
  ...
  \end{block}
  \vspace{6pt}
  \begin{exampleblock}{Supplementary (Covered in Week 5, Part 2 — Research Article \& Case Study)}
    \begin{itemize}
      \small
...
\begin{frame}[c]
  \begin{center}
    ...
    \begin{block}{\centering Next Lecture: Week 5, Part 2}
      \centering
      Research Article: Vavilapalli et al.\ (2013) --- \textit{``Apache Hadoop YARN: Yet Another Resource Negotiator''}\\[4pt]
