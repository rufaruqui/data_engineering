...
\begin{frame}{Textbook \& Reading References}
  ...
  \end{block}
  \vspace{6pt}
  \begin{exampleblock}{Research Articles (covered in Week 7, Part 2)}
    \begin{itemize}
      \small
...
\begin{frame}[c]
  \begin{center}
    ...
    \begin{block}{\centering Next Lecture: Week 7, Part 2}
      \centering
      Research Articles: Thusoo et al.\ (2009, 2010) on Hive architecture and petabyte-scale warehousing\\[4pt]
