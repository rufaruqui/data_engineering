...
% Part 2 covers: Research Article (Laney 2001) · Case Study (McKinsey 2011)
%=================================================================
...
\begin{frame}{Textbook \& Reading References}
  ...
  \end{block}
  \vspace{6pt}
  \begin{exampleblock}{Supplementary\textemdash Covered in Week 1 Part 2 (Research Articles)}
    \small
    \begin{itemize}
...
\begin{frame}[c]
  \begin{center}
    ...
    \begin{block}{\centering Next Lecture: Week 1, Part 2}
      \centering
      Research Article: Laney (2001) $\cdot$ CAP Theorem Formal Proof\\
