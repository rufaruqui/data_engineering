...
\begin{frame}{Textbook \& Reading References}
  ...
  \end{block}
  \vspace{4pt}
  \begin{exampleblock}{Research Articles (covered in Week 11, Part 2)}
    \begin{itemize}
      \small
    ...
    \begin{columns}
      \column{0.48\textwidth}
        \begin{block}{\centering Week 11, Part 2}
          \centering\small
          Research Articles: Armbrust 2020 (Delta Lake) $\cdot$ Zaharia 2021 (Lakehouse) $\cdot$ Akidau 2015 (Dataflow Model)\\[4pt]
