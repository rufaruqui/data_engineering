...
%=================================================================
\section{Research Article: Halevy, Rajaraman \& Ordille (2006)}
%=================================================================
...
\begin{itemize}[leftmargin=1.8em]
  ...
  \item \textbf{Encoding cascades:} A file transmitted from a UTF-8 system and received by a Windows-1252 system corrupts Bangla characters into garbled byte sequences (\texttt{â€™} instead of an apostrophe is a classic encoding cascade artefact).
\end{itemize}
...
\begin{itemize}[leftmargin=2em, itemsep=6pt]
  \item \textbf{Research Article:} Halevy, A., Rajaraman, A., \& Ordille, J.\ (2006). \textit{``Data Integration: The Teenage Years.''} Proceedings of the 32nd International Conference on Very Large Data Bases (VLDB 2006).\\
