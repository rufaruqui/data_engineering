...
\begin{frame}{Textbook \& Reading References}
  ...
  \end{block}
  \vspace{6pt}
  \begin{exampleblock}{Supplementary (Covered in Week 4, Part 2 — Research Articles)}
    \begin{itemize}
      \small
...
\begin{frame}[c]
  \begin{center}
    ...
    \begin{block}{\centering Next Lecture: Week 4, Part 2}
      \centering
      Research Article 1: Dean \& Ghemawat (2004) — \textit{``MapReduce: Simplified Data Processing on Large Clusters''}\\[4pt]
      Research Article 2: Chang et al.\ (2006) — \textit{``Bigtable: A Distributed Storage System for Structured Data''}\\[4pt]
